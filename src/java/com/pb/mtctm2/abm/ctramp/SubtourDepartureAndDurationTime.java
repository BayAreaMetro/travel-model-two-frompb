 ...
 */
public class SubtourDepartureAndDurationTime implements Serializable {
...
//    private double[][] dcSizeArray;
    ...
    public SubtourDepartureAndDurationTime( HashMap<String, String> propertyMap, ModelStructure modelStructure,
    ...
    private void setTourModeChoiceLogsumsForDepartureTimeAndDurationAlternatives( Tour tour, boolean[] altAvailable )
    {
        ...
        String choiceModelDescription = String.format(
                "At-work Subtour Mode Choice Logsum calculation for %s Departure Time Choice", tour.getTourPurpose());
    ...
    public static void main( String[] args )
    {
       ...
       // set values for these arguments so an object instance can be created
        ...
        SubtourDepartureAndDurationTime testObject2 = new SubtourDepartureAndDurationTime( propertyMap, modelStructure, dmuFactory, awmcModel );
...
//        testObject2.applyModel( hh[0], true );
        ...
        UtilityExpressionCalculator uec = new UtilityExpressionCalculator(uecFile, 10, 0, propertyMap, (VariableTable) todDmuObject);

        ...
        extends JPPFTask
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            this.uecIndices = (int[]) dataProvider.getValue("uecIndices");
            this.soaUecIndices = (int[]) dataProvider.getValue("soaUecIndices");
...
//      hhModelManager = null;
        ...
        WorkLocationChoiceModel dcModel = modelManager.getWorkLocModelObject(taskIndex, iteration, dcSizeObj, uecIndices, soaUecIndices);

        ...
        implements Serializable
{
        ...
        for (int j = 1; j < personArray.length; ++j)
        {
            ...
            for (Tour tour : tourList)
            {
                ...
                try
                {
                    ...
                    // save the chosen alternative and create and populate the arrays
                    ...
                    logger
                            .error(String
                                    .format(
                                            ...
                                            tour.getTourCategory(), j, household.getHhId(), person
                                                    .getPersonNum(), tourCount));
                    throw new RuntimeException(e);
                }
    ...
    private int setStopFreqChoice(Tour tour, int stopFreqChoice)
    {
        ...
        if (numObStops > 0)
        {
            // get a stop purpose for each outbound stop generated, plus the stop at
            ...
            // pass in the array of stop purposes; length of array determines number
    ...
    private void readPurposeLookupProportionsTable(String purposeLookupFilename)
    {
        ...
        // create a mapping between stop purpose alternative indices selected from
        ...
        // create a mapping between names used in lookup file and person type names
        // used in model
        ...
        // PrimPurp Direction DepartRangeStart DepartRangeEnd Ptype Work University
        // School Escort Shop Maintenance Eating Out Visiting Discretionary

        // populate the outProportionsMaps and inProportionsMaps arrays of maps from
        // data in the TableDataSet.
        // when stops are generated, they can lookup the proportions for stop purpose
        ...
        for (int i = 0; i < purposeLookupTable.getRowCount(); i++)
        {
            ...
            // columns following person type are proportions by stop purpose. Get the
            ...
            // get a HashMap for the direction and each hour in the start/end range,
            ...
            // if the person type for the record is "All", a key is defined for each

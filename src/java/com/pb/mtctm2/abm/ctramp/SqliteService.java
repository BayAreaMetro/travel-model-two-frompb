...
public class SqliteService
{
    ...
    public void connect(String fileName, String tableName) throws DAOException
    {
        ...
        try
        {
            ...
            s.execute("CREATE TABLE IF NOT EXISTS " + tableName + " (" + "   id INTEGER, "
                    + "   numProcessed INTEGER, " + "   totalToProcess INTEGER, "
                    + "   startUp INTEGER, " + "   runTime INTEGER, " + "   shutDown INTEGER "
                    + ")");
        ...
        try
        {
            ...
            while(rs.next())
            {
                System.out.println(rs.getInt("id") + ", " + rs.getInt("numProcessed") + ", "
                        ...
                        + rs.getInt("runTime") + ", " + rs.getInt("shutDown"));
            }
    ...
    public void insertRecord(String tableName, int id, int numProcessed, int totalToProcess,
            int startUp, int runTime, int shutDown) throws DAOException
    {
    ...
    public void updateRecord(String tableName, int id, int numProcessed, int totalToProcess,
            int startUp, int runTime, int shutDown) throws DAOException
    {

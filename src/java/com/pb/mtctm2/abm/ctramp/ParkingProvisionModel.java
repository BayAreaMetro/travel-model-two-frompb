        ...
        implements Serializable
{
    ...
    private void setupFreeParkingChoiceModelApplication(HashMap<String, String> propertyMap, CtrampDmuFactoryIf dmuFactory)
    {
        ...
        fpModel = new ChoiceModelApplication(fpUecFile, modelSheet, dataSheet, propertyMap, (VariableTable) fpDmuObject);
    ...
    private int getParkingChoice (Person personObj, double randomNumber) {
        ...
        if (fpModel.getAvailabilityCount() > 0) {
            ...
            String errorMessage = String.format("Exception caught for %s, no available free parking alternatives to choose from in choiceModelApplication.", decisionMaker );

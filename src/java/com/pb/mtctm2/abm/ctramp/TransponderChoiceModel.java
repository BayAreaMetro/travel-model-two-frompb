        ...
        implements Serializable
{
    ...
    public TransponderChoiceModel( HashMap<String, String> propertyMap, CtrampDmuFactoryIf dmuFactory, AccessibilitiesTable accTable,
    ...
    private void setupTransponderChoiceModelApplication(HashMap<String, String> propertyMap, CtrampDmuFactoryIf dmuFactory)
    {
        ...
        tpModel = new ChoiceModelApplication(tpUecFile, modelSheet, dataSheet, propertyMap, (VariableTable) tpDmuObject);
    ...
    public void applyModel(Household hhObject){
        ...
        tpDmuObject.setDmuIndexValues( hhObject.getHhId(), hhObject.getHhTaz(), hhObject.getHhTaz(), 0 );
        
        tpDmuObject.setPctIncome100Kplus( pctHighIncome[homeTaz] ); 
        tpDmuObject.setPctIncome75Kplus( pctMedHighPlusIncome[homeTaz] );
        ...
        if ( tpModel.getAvailabilityCount() > 0) {
            ...
            String errorMessage = String.format("Exception caught for %s, no available transponder choice alternatives to choose from in choiceModelApplication.", decisionMaker );

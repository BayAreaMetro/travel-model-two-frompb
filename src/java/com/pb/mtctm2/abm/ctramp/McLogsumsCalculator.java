...
public class McLogsumsCalculator implements Serializable
{
    ...
    public void setWtwTripMcDmuAttributesForBestTapPairs( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
     ...
     // walk access and walk egress for transit segment
        int skimPeriodIndex = ModelStructure.getSkimPeriodIndex(departPeriod);
        skimPeriodIndex = skimPeriodIndex;
    ...
    public void setDtwTripMcDmuAttributesForBestTapPairs( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
    ...
    public void setWtdTripMcDmuAttributesForBestTapPairs( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
    ...
    public void setWtwTripMcDmuAttributes( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, boolean loggingEnabled )
    {
        ...
        bestTripTapPairs = wtw.getBestTapPairs( origMgra, destMgra, skimPeriodIndex, loggingEnabled, wtwSkimLogger );

        int i = Modes.getTransitModeIndex("CR");
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
       }
        else {
            crSkims = wtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lrSkims = wtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            brSkims = wtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            ebSkims = wtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lbSkims = wtw.getNullTransitSkims(i);
        }
    ...
    public void setWtdTripMcDmuAttributes( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, boolean loggingEnabled )
    {
        ...
        bestTripTapPairs = wtd.getBestTapPairs(origMgra, destMgra, skimPeriodIndex, loggingEnabled, wtdSkimLogger);
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            crSkims = wtd.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lrSkims = wtd.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            brSkims = wtd.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            ebSkims = wtd.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lbSkims = wtd.getNullTransitSkims(i);
        }
    ...
    public void setDtwTripMcDmuAttributes( TripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, boolean loggingEnabled )
    {
        ...
        // store best tap pairs using outbound direction array
        bestTripTapPairs = dtw.getBestTapPairs(origMgra, destMgra, skimPeriodIndex, loggingEnabled, dtwSkimLogger);
       
        int i = Modes.getTransitModeIndex("CR");
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            crSkims = dtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lrSkims = dtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            brSkims = dtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            ebSkims = dtw.getNullTransitSkims(i);
        }
        ...
        if (bestTripTapPairs[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTripTapPairs[i][0], bestTripTapPairs[i][1], skimPeriodIndex, loggingEnabled);
        }
        else {
            lbSkims = dtw.getNullTransitSkims(i);
        }
    ...
    /**
     * methods that call this method pass in the DMU object, an access indicator, and the skims arrays for setting skim values in the DMU object
     * 
     * @param tripMcDmuObject trip mode choice DMU object
     * @param access access/egress indicator ( McLogsumsCalculator.WTW, McLogsumsCalculator.DTW, or McLogsumsCalculator.WTD)
     * @param lbSkims skims values for local bus
     * @param ebSkims skims values for express bus
     * @param brSkims skims values for BRT
     * @param lrSkims skims values for LRT
     * @param crSkims skims values for commuter rail
     */
    private void setTripMcAttributes( TripModeChoiceDMU tripMcDmuObject, int access, double[] lbSkims, double[] ebSkims, double[] brSkims, double[] lrSkims, double[] crSkims )
    {

...
{                                                                                                                                                                                                 
    ...
    {                                                                                                                                                                                             
        ...
        dcSoaModel = new DestinationSampleOfAlternativesModel(soaUecFile, soaSampleSize,                                                                                                          
                propertyMap, mgraManager, dcSizeObj.getDcSizeArray(), dcSoaDmuObject, soaUecSheetIndices);                                                                                        
        ...
        {                                                                                                                                                                                         
            ...
            {                                                                                                                                                                                     
                logger.fatal( String.format("exception caught setting up DC ChoiceModelApplication[%d] for modelIndex=%d of %d models", i, modelIndex, modelIndexMap.size()) );                   
    ...
    {                                                                                                                                                                                             
        ...
        {                                                                                                                                                                                         
            ...
            {                                                                                                                                                                                     
                logger.fatal(String.format("Exception caught in dcModel selecting location for i=%d, hh.hhid=%d, person i=%d, in work location choice, occup=%d, segmentIndex=%d, segmentName=%s",
        ...
        {                                                                                                                                                                                         
            ...
            {                                                                                                                                                                                     
                ...
                if (p.getPersonIsPreschoolChild() == 1) {                                                                                                                                         
                    segmentIndex = segmentNameIndexMap.get( BuildAccessibilities.SCHOOL_DC_SIZE_SEGMENT_NAME_LIST[BuildAccessibilities.PRESCHOOL_SEGMENT_GROUP_INDEX] );                          
                    ...
                    segmentIndex = segmentNameIndexMap.get(  BuildAccessibilities.SCHOOL_DC_SIZE_SEGMENT_NAME_LIST[BuildAccessibilities.UNIV_TYPICAL_SEGMENT_GROUP_INDEX] );                      
                    segmentType = BuildAccessibilities.UNIV_TYPICAL_ALT_INDEX;                                                                                                                    
                }                                                                                                                                                                                 
                else if (p.getPersonIsUniversityStudent() == 1 && p.getAge() >= 30) {                                                                                                             
                    segmentIndex = segmentNameIndexMap.get(  BuildAccessibilities.SCHOOL_DC_SIZE_SEGMENT_NAME_LIST[BuildAccessibilities.UNIV_NONTYPICAL_SEGMENT_GROUP_INDEX] );                   
                    segmentType = BuildAccessibilities.UNIV_NONTYPICAL_ALT_INDEX;                                                                                                                 
                }                                                                                                                                                                                 
                                                                                                                                                                                                  
                // if person type is a student but segment index is -1, the person is not enrolled                                                                                                
                ...
                {                                                                                                                                                                                 
                    // if the segment is in the skip shadow pricing set, and the iteration is > 0, dont' compute new choice                                                                       
            ...
            {                                                                                                                                                                                     
                ...
                /**                                                                                                                                                                               
                 * remove following - don't need non-mandatory accessibility since we're doing shadow pricing for school tours                                                                    
                   // set the auto sufficiency dependent non-mandatory accessibility value for the household                                                                                      
                   int autoSufficiency = hh.getAutoSufficiency();                                                                                                                                 
                   float accessibility = aggAcc.getAggregateAccessibility( nonMandatoryAccessibilityTypes[autoSufficiency], hh.getHhMgra() );                                                     
                   dcDmuObject.setNonMandatoryAccessibility( accessibility );                                                                                                                     
                 */                                                                                                                                                                               
                ...
                results = selectLocationFromSampleOfAlternatives("school", segmentType, p, segmentNameList[segmentIndex], segmentIndex, tourNum++,                                                
                        homeMgraSizeArray, mgraDistanceArray );                                                                                                                                   
            ...
            {                                                                                                                                                                                     
                logger.fatal(String.format(                                                                                                                                                       
                    "Exception caught in dcModel selecting location for i=%d, hh.hhid=%d, person i=%d, in school location choice, modelIndex=%d, segmentIndex=%d, segmentName=%s",                
                    i, hh.getHhId(), i, modelIndex, segmentIndex, segmentNameList[segmentIndex]));                                                                                                
                logger.fatal("Exception caught:", e);                                                                                                                                             
                logger.fatal("calling System.exit(-1) to terminate.");                                                                                                                            
                System.exit(-1);                                                                                                                                                                  
            }                                                                                                                                                                                     
    ...
    {                                                                                                                                                                                             
        ...
        locationChoiceModel.computeUtilities( dcDmuObject, dcDmuObject.getDmuIndexValues(), destAltsAvailable, destAltsSample );                                                                  
        ...
        {                                                                                                                                                                                         
            logger.error(String.format(                                                                                                                                                           
                ...
                dcDmuObject.getHouseholdObject().getHhId(), dcDmuObject.getPersonObject().getPersonNum(), segmentName));                                                                          
        }                                                                                                                                                                                         
        ...
        {                                                                                                                                                                                         
            ...
            if ( sortedSelectedIndex >= 0){                                                                                                                                                       
                ...
                modelLogger.info(String.format(                                                                                                                                                   
                    "Choice: %s, dist=%.6e, logsum=%.6e with rn=%.8f, randomCount=%d", altString,                                                                                                 
                    sampleAlternativeDistances[selectedIndex],                                                                                                                                    
                    sampleAlternativeLogsums[selectedIndex], rn, randomCount));                                                                                                                   
            }                                                                                                                                                                                     
            else {                                                                                                                                                                                
                modelLogger.info(" ");                                                                                                                                                            
                modelLogger.info(String.format("j=%d, mgra=None selected, no alternatives available", selectedIndex ));                                                                           
                modelLogger.info(String.format( "Choice: %s, rn=%.8f, randomCount=%d", "N/A", rn, randomCount));                                                                                  
            }                                                                                                                                                                                     
    ...
    {                                                                                                                                                                                             
        ...
        {                                                                                                                                                                                         
            logger.fatal(String.format(                                                                                                                                                           
                ...
                dcDmuObject.getHouseholdObject().getHhId(), dcDmuObject.getPersonObject().getPersonNum()) );                                                                                      
            logger.fatal("calling System.exit(-1) to terminate.");                                                                                                                                
            System.exit(-1);                                                                                                                                                                      
        }                                                                                                                                                                                         

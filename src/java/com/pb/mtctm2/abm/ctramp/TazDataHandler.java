        ...
        implements TazDataIf, Serializable
{
    ...
    // zoneTableRow is a correspondence between zone number (i,e, origin taz or dest
    ...
    // (1,...,numZones*numSubzones) and 0-based subzone index (0,...,numSubZones-1)
    protected int[]               altToSubZone;

    // 1st dimension is indexed by zone number, 2nd dimension is walk segments - e.g.
    // 0: no walk %, 1: shrt %, 2: long %.
    protected float[][]           zonalWalkPctArray;

    protected String[]            subZoneNames;

    // TODO: need to apply consistent zone number/zone table row/o & d zonal index/
    // correspondence defined in this class
    // TODO: and make sure that proper indexing is applied in all models that use
    // zone table data.
    ...
    private TableDataSet readZonalData(String zoneDataFileName)
    {
        ...
        try
        {
            ...
            // set global max zone and num zones values, and make sure there are no
            // duplicates.

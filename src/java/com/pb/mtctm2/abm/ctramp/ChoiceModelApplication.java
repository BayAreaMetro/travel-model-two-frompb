...
public class ChoiceModelApplication
        implements java.io.Serializable
{

    private transient Logger            logger               = Logger
                                                                     .getLogger(ChoiceModelApplication.class);
    ...
    public ChoiceModelApplication(String controlFileName, int modelSheet, int dataSheet,
            HashMap<String, String> propertyMap, Object dmuObject)
    {
        ...
        // try {
        // logger.info( uecFile + " UEC[" + modelSheet + "]  size = " +
        // (ObjectUtil.checkObjectSize( uec )/(1024*1024)) + " MB." );
        // } catch (IOException e) {

...
public class VisitorStopLocationChoiceDMU        implements Serializable, VariableTable
{
	...
	/**
	 * @param stopsOnHalfTour the stopsOnHalfTour to set
	 */
	...
	/**
	 * @param inboundStop the inboundStop to set
	 */
	...
	/**
	 * @param osMcLogsumAlt the osMcLogsumAlt to set
	 */
	...
	/**
	 * @param sdMcLogsumAlt the sdMcLogsumAlt to set
	 */
	...
	/**
	 * @param tourOrigToStopDistanceAlt the tourOrigToStopDistanceAlt to set
	 */
	...
	/**
	 * @param stopToTourDestDistanceAlt the stopToTourDestDistanceAlt to set
	 */

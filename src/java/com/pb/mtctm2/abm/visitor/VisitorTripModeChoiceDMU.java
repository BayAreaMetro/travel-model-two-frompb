...
public class VisitorTripModeChoiceDMU        implements Serializable, VariableTable
{
	...
	/**
	 * @param tourModeIsBike the tourModeIsBike to set
	 */
	...
	/**
	 * @param tourModeIsWalkTransit the tourModeIsWalkTransit to set
	 */
	...
	/**
	 * @param tourModeIsPNRTransit the tourModeIsPNRTransit to set
	 */
	...
	/**
	 * @param tourModeIsKNRTransit the tourModeIsKNRTransit to set
	 */
	...
	/**
	 * @param tourModeIsTaxi the tourModeIsTaxi to set
	 */

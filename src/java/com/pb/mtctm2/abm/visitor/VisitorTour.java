...
public class VisitorTour implements Serializable{
	
	private MersenneTwister random;
	private int ID;
	
	//following variables determined via simulation
	private byte segment;  //0 = business, 1 = personal
	...
	/**
	 * @param inboundStops the inboundStops to set
	 */
	...
	/**
	 * @param autoAvailable the autoAvailable to set
	 */

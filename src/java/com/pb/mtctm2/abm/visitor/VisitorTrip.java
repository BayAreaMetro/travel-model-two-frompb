...
public class VisitorTrip implements Serializable{
    ...
    /**
     * Create a visitor trip from a tour\stop.  Note:  trip mode 
	...
	/**
	 * @param tripMode the tripMode to set
	 */
	...
	/**
	 * @param bestWtwTapPairs the bestWtwTapPairs to set
	 */
	...
	/**
	 * @param bestWtdTapPairs the bestWtdTapPairs to set
	 */
	...
	/**
	 * @param bestDtwTapPairs the bestDtwTapPairs to set
	 */
	...
	/**
	 * @param originIsTourDestination the originIsTourDestination to set
	 */
	...
	/**
	 * @param destinationIsTourDestination the destinationIsTourDestination to set
	 */

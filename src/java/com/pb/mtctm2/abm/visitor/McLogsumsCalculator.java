...
public class McLogsumsCalculator implements Serializable
{
    ...
    /**
     * This method finds the best walk-transit-walk tap pairs if they don't exist in the trip object (and sets the best tap pairs in the 
     * trip object), then fills in the trip mode choice DMU object with the skim values corresponding to those tap pairs.
     * 
     * @param tour
     * @param trip
     * @param mcDmuObject
     */
     public void setTripMcDmuSkimAttributes( VisitorTour tour, VisitorTrip trip, VisitorTripModeChoiceDMU mcDmuObject)
     {
    ...
    public double calculateTourMcLogsum(int origMgra, int destMgra, int departPeriod, int arrivePeriod,
        ChoiceModelApplication mcModel, VisitorTourModeChoiceDMU mcDmuObject)
    {
    ...
    private void setNmTripMcDmuAttributes( VisitorTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, boolean loggingEnabled )
    {
    ...
    private void setNmTourMcDmuAttributes( VisitorTourModeChoiceDMU mcDmuObject, int origMgra, int destMgra, int departPeriod, int arrivePeriod, boolean loggingEnabled )
    {
        // non-motorized, outbound then inbound
        int skimPeriodIndex = ModelStructure.getSkimPeriodIndex(departPeriod);
        departPeriod = skimPeriodIndex;
    ...
    private void setWtwTourMcDmuAttributes( VisitorTourModeChoiceDMU mcDmuObject, int origMgra, int destMgra, int departPeriod, int arrivePeriod, boolean loggingEnabled )
    {
        // walk access, walk egress transit, outbound
        int skimPeriodIndex = ModelStructure.getSkimPeriodIndex(departPeriod);
        departPeriod = skimPeriodIndex;
        bestWtwTapPairsOut = wtw.getBestTapPairs(origMgra, destMgra, departPeriod, loggingEnabled, wtwSkimLogger);
        ...
        if (bestWtwTapPairsOut[i] != null) {
            ...
            crSkimsOut = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsOut[i][0], bestWtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsOut = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsOut[i][0], bestWtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsOut = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsOut[i][0], bestWtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsOut = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsOut[i][0], bestWtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsOut = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsOut[i][0], bestWtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        skimPeriodIndex = ModelStructure.getSkimPeriodIndex(arrivePeriod);
        arrivePeriod = skimPeriodIndex;
        bestWtwTapPairsIn = wtw.getBestTapPairs(destMgra, origMgra, arrivePeriod, loggingEnabled, wtwSkimLogger);
        ...
        if (bestWtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkimsIn = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsIn[i][0], bestWtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsIn = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsIn[i][0], bestWtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsIn = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsIn[i][0], bestWtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsIn = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsIn[i][0], bestWtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsIn = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestWtwTapPairsIn[i][0], bestWtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
    ...
    private void setWtdTourMcDmuAttributes( VisitorTourModeChoiceDMU mcDmuObject, int origMgra, int destMgra, int departPeriod, int arrivePeriod, boolean loggingEnabled )
    {
        // walk access, drive egress transit, outbound
        int skimPeriodIndex = ModelStructure.getSkimPeriodIndex(departPeriod);
        departPeriod = skimPeriodIndex;
        bestWtdTapPairsOut = wtd.getBestTapPairs(origMgra, destMgra, departPeriod, loggingEnabled, wtdSkimLogger);
        ...
        if (bestWtdTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkimsOut = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsOut[i][0], bestWtdTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsOut = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsOut[i][0], bestWtdTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsOut = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsOut[i][0], bestWtdTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsOut = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsOut[i][0], bestWtdTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsOut = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsOut[i][0], bestWtdTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        skimPeriodIndex = ModelStructure.getSkimPeriodIndex(arrivePeriod);
        arrivePeriod = skimPeriodIndex;
        bestWtdTapPairsIn = wtd.getBestTapPairs(destMgra, origMgra, arrivePeriod, loggingEnabled, wtdSkimLogger);
        ...
        if (bestWtdTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkimsIn = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsIn[i][0], bestWtdTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsIn = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsIn[i][0], bestWtdTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsIn = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsIn[i][0], bestWtdTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsIn = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsIn[i][0], bestWtdTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestWtdTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsIn = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestWtdTapPairsIn[i][0], bestWtdTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
    ...
    private void setDtwTourMcDmuAttributes( VisitorTourModeChoiceDMU mcDmuObject, int origMgra, int destMgra, int departPeriod, int arrivePeriod, boolean loggingEnabled )
    {
        // drive access, walk egress transit, outbound
        int skimPeriodIndex = ModelStructure.getSkimPeriodIndex(departPeriod);
        departPeriod = skimPeriodIndex;
        bestDtwTapPairsOut = dtw.getBestTapPairs(origMgra, destMgra, departPeriod, loggingEnabled, dtwSkimLogger);
        ...
        if (bestDtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkimsOut = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsOut[i][0], bestDtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsOut = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsOut[i][0], bestDtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsOut = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsOut[i][0], bestDtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsOut = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsOut[i][0], bestDtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsOut[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsOut = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsOut[i][0], bestDtwTapPairsOut[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        skimPeriodIndex = ModelStructure.getSkimPeriodIndex(arrivePeriod);
        arrivePeriod = skimPeriodIndex;
        bestDtwTapPairsIn = dtw.getBestTapPairs(destMgra, origMgra, arrivePeriod, loggingEnabled, dtwSkimLogger);
        ...
        if (bestDtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            crSkimsIn = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsIn[i][0], bestDtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lrSkimsIn = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsIn[i][0], bestDtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            brSkimsIn = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsIn[i][0], bestDtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            ebSkimsIn = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsIn[i][0], bestDtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
        ...
        if (bestDtwTapPairsIn[i] != null) {
            double pWalkTime = bestPathUEC.getBestAccessTime( i );
            double aWalkTime = bestPathUEC.getBestEgressTime( i );
            lbSkimsIn = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestDtwTapPairsIn[i][0], bestDtwTapPairsIn[i][1], arrivePeriod, loggingEnabled);
        }
        else {
    ...
    private void setWtwTripMcDmuAttributes( VisitorTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled)
    {
        ...
        if (bestTapPairs[i] != null) {
            ...
            crSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lrSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            brSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            ebSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lbSkims = wtw.getWalkTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
    ...
    private void setWtdTripMcDmuAttributes( VisitorTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findDriveTransitEgressTime(destMgra, bestTapPairs[i][1]);
            crSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findDriveTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lrSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findDriveTransitEgressTime(destMgra, bestTapPairs[i][1]);
            brSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findDriveTransitEgressTime(destMgra, bestTapPairs[i][1]);
            ebSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findWalkTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findDriveTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lbSkims = wtd.getWalkTransitDriveSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
    ...
    private void setDtwTripMcDmuAttributes( VisitorTripModeChoiceDMU tripMcDmuObject, int origMgra, int destMgra, int departPeriod, int[][] bestTapPairs, boolean loggingEnabled )
    {
        ...
        if (bestTapPairs[i] != null) {
            ...
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            crSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findDriveTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lrSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findDriveTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            brSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findDriveTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            ebSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {
        ...
        if (bestTapPairs[i] != null) {
            double pWalkTime = BestTransitPathCalculator.findDriveTransitAccessTime(origMgra, bestTapPairs[i][0]);
            double aWalkTime = BestTransitPathCalculator.findWalkTransitEgressTime(destMgra, bestTapPairs[i][1]);
            lbSkims = dtw.getDriveTransitWalkSkims(i, pWalkTime, aWalkTime, bestTapPairs[i][0], bestTapPairs[i][1], departPeriod, loggingEnabled);
        }
        else {

...
public class StoredUtilityData
{
    ...
    public static synchronized StoredUtilityData getInstance( int maxMgra, int maxTap, int maxTaz, int numAccEgrSegments, int numPeriods )
    {
        if (objInstance == null) {
    ...
    private void setupStoredDataArrays( int maxMgra, int maxTap, int maxTaz, int numAccEgrSegments, int numPeriods ){        
